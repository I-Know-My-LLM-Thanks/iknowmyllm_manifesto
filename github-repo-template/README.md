...
[![Signatories](https://img.shields.io/badge/Signatories-Growing-green)](#signatories)
...
- **The "Combined Experience" Math**: "100+ years combined AI experience" — LinkedIn reveals 35 years total, 4 in AI specifically.
- **The "Senior Bank Executive"**: No FINRA registration. Actually a project manager who worked on CRM upgrades.
- **The Revolutionary Terminology**: "Cognitive Knowledge Orchestration™" — Zero Google Scholar results.
- **The Confidential Case Study**: "A leading consortium reduced timelines by 73%" — Cannot be named, contacted, or verified.
...
- **Submit PRs** for principle refinements
...
2. **Edit** `signatures.csv` - add a new line with your signature
...
See [SIGNATORIES.md](SIGNATORIES.md) for the full list of community members who have signed the manifesto.
...
**Keywords**: AI manifesto principles, trustworthy AI community, AI fraud awareness, AI ethics, evaluate AI platforms, AI red flags

# The 8 Principles of I Know My LLM

These actionable principles help you evaluate AI platforms and protect yourself from fraud. They are open for community refinement.
...
🎪 *Red Flag Example*: "100+ years of combined AI experience" — LinkedIn reveals 35 years total, 4 in AI specifically.

**Action Items:**
- Cross-reference LinkedIn with FINRA BrokerCheck, SEC filings
- Verify claimed publications on Google Scholar
- Check company registries for actual roles and tenure
- Look for independent confirmation beyond self-reported profiles

---

## 2. Demand Concrete Proof

**Require working demos, named references, and verifiable case studies before sharing data.**
...
- Ask for named, contactable references (not just logos)
- Verify case study companies exist and can confirm the claims
- Never share data before seeing the product work

---

## 3. Spot Hype and Jargon

**Identify invented terms, generic AI copy, and unsubstantiated claims as red flags.**
...
- Ask specifically: Where is data stored? Who has access? How is it encrypted?
- Verify certifications with the issuing bodies
- Check for data breach history

---

## 5. Research Regulatory Standing

**Review FINRA, SEC, FCA filings, and physical/financial legitimacy for stability.**
...
🎪 *Red Flag Example*: "Senior bank executive managing billions" — FINRA shows no registration, ever.

**Action Items:**
- Search FINRA BrokerCheck for financial industry claims
- Check SEC EDGAR for company filings
- Verify addresses via Google Street View
- Review state/national business registries
- Check FCA (UK), ASIC (Australia), or relevant local regulators
...
- Question any NDA required before seeing a demo
- Understand data portability and contract termination rights
- Review pricing transparency and hidden fees
...
**Record claims, communications, and interactions for accountability.**
...
- Keep copies of contracts and terms
- Document any discrepancies between claims and reality

---

## 8. Leverage Instincts and Community
...
- Search for independent reviews and experiences
- Ask in professional communities and forums
- Share your own findings to help others
- Report suspicious patterns to relevant authorities
